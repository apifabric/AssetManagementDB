...
resourcename="ecommercemodel"  # lower case, only
resourcegroup="ecommercemodel_rg"
...
# git clone https://github.com/apilogicserver/ecommercemodel.git
# cd ecommercemodel
...
az group create --name ecommercemodel_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group ecommercemodel_rg --sku S1 --is-linux
az container create --resource-group ecommercemodel_rg --name ecommercemodel --image apilogicserver/ecommercemodel:latest --dns-name-label ecommercemodel --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//ecommercemodel.westus.azurecontainer.io:5656'
